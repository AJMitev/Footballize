namespace Footballize.Common.FileTypeChecker
{
    ...
    public class FileTypeChecker : IFileTypeChecker
    {
        private static readonly IList<IFileType> knownFileTypes = new List<IFileType>
        {
            ...
            new FileType("JPEG", ".jpg", new FileTypeMatcher( new byte[] {0xFF, 0xD8,0xFF})),
            new FileType("PNG", ".png", new FileTypeMatcher( new byte[] {0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A})),
